...
if __name__ == '__main__':
    ...
    plt.legend(legend_lst, ncol=len(legend_lst),
               prop={'size': 11, "weight": "bold"}, loc=2,
               bbox_to_anchor=(-3.4, 1.3, 4.0, 0.0), mode='expand')

    plt.savefig('scalability_roll_graph.' + 'png', dpi=1200)
    # exp2_figure.show()
    plt.close()
