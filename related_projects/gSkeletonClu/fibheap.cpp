...
void FibHeapNode::operator =(double NewKeyVal)
{
     FibHeapNode Temp;
...
//===========================================================================
int FibHeap::DecreaseKey(FibHeapNode *theNode, double NewKey)
{
  FibHeapNode *theParent;

     if (theNode==NULL || theNode->GetKeyValue() < NewKey)
         return NOTOK;
...
FibHeapNode* Temp = NULL;
	...
	if (Temp->Right == NULL)
	     ...
	     printf( "(Error in left link left) ->" );
	else printf( " <-> " );
